...
const values = [
  "Hospital-trained nurses with years experience",
...
export function AboutSection() {
  return (
    <section
      id="about"
      className="py-20 lg:py-28 bg-linear-to-b from-gray-50 to-white relative overflow-hidden"
    >
      {/* Background Blobs */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight animate-slide-up animation-delay-300">
              Specialized Care for the Healing Journey{" "}
            ...
            <p className="text-md text-gray-700 mb-6 leading-relaxed animate-slide-up animation-delay-400">
              Hospital discharge is just the beginning. We are a team of
              neuro-specialists and educators dedicated to reimagining
              out-of-hospital recovery. By combining evidence-led rehabilitation
              with compassionate caregiver coaching, we can nurture you back to
              health in the place you feel safest.
            </p>

            {/* <p className="text-md text-gray-600 mb-8 leading-relaxed animate-slide-up animation-delay-500">
              Our mission is simple: provide compassionate, professional
              healthcare that allows patients to recover in the comfort and
              dignity of their own homes, while giving families peace of mind
              through real-time updates and transparent communication.
            </p> */}
            ...
            <Link
              href="/client/booking"
              className="inline-flex items-center gap-2 text-primary font-semibold hover:underline animate-slide-up animation-delay-700"
            >
              <Button
                size="lg"
                className="font-semibold bg-primary hover:shadow-2xl hover:shadow-primary/30 hover:scale-105 transition-all duration-300 animate-slide-up animation-delay-700 group rounded-[2rem]"
              >
                Start Your Recovery Plan here
