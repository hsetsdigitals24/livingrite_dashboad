        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2 animate-slide-up animation-delay-100">
            ...
            <p className="text-gray-900 mb-6 leading-relaxed max-w-sm">
              Nigeria's premier home healthcare service, delivering hospital-quality care with compassion and expertise.
            </p>
          ...
          <div className="animate-slide-up animation-delay-400">
            <h3 className="font-semibold text-lg mb-4 text-black">Newsletter</h3>
            <p className="text-gray-900 text-sm mb-4">Get weekly healthcare tips and updates</p>
