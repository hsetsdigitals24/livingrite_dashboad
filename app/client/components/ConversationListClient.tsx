  ...
  if (conversations.length === 0) {
    return (
      <div className="p-4 text-center text-gray-500">
        ...
        <p className="text-sm mt-2">Message a caregiver about your patient</p>
      </div>
    );
  }
        ...
        >
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-3 flex-1 min-w-0">
              {conversation.caregiver.image && (
                <Image
                  src={conversation.caregiver.image}
                  alt={conversation.caregiver.name || 'Caregiver'}
                  width={40}
                  height={40}
